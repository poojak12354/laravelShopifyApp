...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Picture Perfect'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '10ca4fe284f44a1c5d1dab1508350c5b'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '87b63636f80805ef7e2d4cce030c80d3'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,write_order_edits, read_order_edits, write_orders, read_orders,write_customers, read_customers,read_script_tags, write_script_tags'),
    ...
    */
    ...
    'scripttags' => [
        [
            'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', env('APP_URL'). '/appScript/script.js'),
