    ...
    <div style="background-color:#ffffff; max-width: 600px; border: 1px solid #eee; margin: 0 auto;">
       ...
       <div style="padding:10px;">
            <div style="text-align: center;">
                <h3 style="font-size: 20px; margin: 0 0 12px; color: #000;">Thanks for submitting a quote request!</h3>
                <p style="font-size: 16px; line-height: 28px; color: #000; font-weight: 400;">This email is to let you know that we’ve received your quote request.<br>
                We'll review, prepare and send it to you within 24 hours.<br>
                We'll contact you if we have any question. If you don’t hear from us, you
                can reply to this email to find out the status of your quote.</p>
            </div>
            <hr>
            ...
            <table>
                ...
                <tr><td>Difficulty: </td><td>{{$details['image_quantity']}}</td></tr>
                <tr><td>Straighten, crop and set margin - Included: </td><td>{{$details['straighten']}}</td></tr>
